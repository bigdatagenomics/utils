...
import org.bdgenomics.utils.parquet.io.{ FileLocator, LocalFileLocator, ByteAccess }
import org.bdgenomics.utils.parquet.rdd.{ Footer, ParquetCommon, ParquetRowGroup }
